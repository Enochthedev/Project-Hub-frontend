...
const UI_EMAIL_DOMAINS = ["@ui.edu.ng", "@stu.ui.edu.ng", "@student.ui.edu.ng", "@postgrad.ui.edu.ng"]
...
export const loginSchema = z.object({
  email: z.string().min(1, "Email is required").email("Please enter a valid email address").refine(isUIEmail, {
...
// Signup schema (alias for registerSchema for backward compatibility)
