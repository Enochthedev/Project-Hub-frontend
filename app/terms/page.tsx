  ...
  return (
    <main className="container py-12">
      <div className="mx-auto max-w-3xl">
        <h1 className="text-3xl font-bold tracking-tight text-[#534D56] dark:text-[#F8F1FF] sm:text-4xl mb-8">
          Terms of Service
        </h1>

        <div className="prose prose-slate dark:prose-invert max-w-none text-[#656176] dark:text-[#DECDF5]">
          <p className="lead">Last updated: May 15, 2025</p>

          <p>
            Please read these Terms of Service ("Terms", "Terms of Service") carefully before using the Project Hub
            website (the "Service") operated by Project Hub, Inc. ("us", "we", or "our").
          </p>
          ...
          <h2 className="text-2xl font-bold text-[#534D56] dark:text-[#F8F1FF] mt-8 mb-4">1. Accounts</h2>
          ...
          <h2 className="text-2xl font-bold text-[#534D56] dark:text-[#F8F1FF] mt-8 mb-4">2. Content</h2>
          ...
          <h2 className="text-2xl font-bold text-[#534D56] dark:text-[#F8F1FF] mt-8 mb-4">3. Intellectual Property</h2>

          <p>
            The Service and its original content (excluding Content provided by users), features, and functionality are
            and will remain the exclusive property of Project Hub, Inc. and its licensors. The Service is protected by
          ...
          <h2 className="text-2xl font-bold text-[#534D56] dark:text-[#F8F1FF] mt-8 mb-4">
          ...
          <p>
            Project Hub, Inc. has no control over, and assumes no responsibility for, the content, privacy policies, or
            practices of any third-party web sites or services. You further acknowledge and agree that Project Hub, Inc.
          ...
          <h2 className="text-2xl font-bold text-[#534D56] dark:text-[#F8F1FF] mt-8 mb-4">5. Termination</h2>
          ...
          <p>
            In no event shall Project Hub, Inc., nor its directors, employees, partners, agents, suppliers, or
          ...
          <h2 className="text-2xl font-bold text-[#534D56] dark:text-[#F8F1FF] mt-8 mb-4">7. Changes</h2>
          ...
          <h2 className="text-2xl font-bold text-[#534D56] dark:text-[#F8F1FF] mt-8 mb-4">8. Contact Us</h2>

          <p>If you have any questions about these Terms, please contact us at support@projecthub.com.</p>
        </div>
      </div>
    </main>
  )
